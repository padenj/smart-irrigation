    ...
    return {
        ...
        forecast: {
            today: {
                ...
                snowProbability: forecastData.forecast.forecastday[0].day.daily_chance_of_snow,
            ...
            tomorrow: {
                ...
                snowProbability: forecastData.forecast.forecastday[1].day.daily_chance_of_snow,
